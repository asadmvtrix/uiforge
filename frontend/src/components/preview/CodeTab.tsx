  ...
  return (
    <div className="relative">
      <div className="flex justify-start items-center px-4 mb-2">
        <span
          title="Copy Code"
          className="bg-black text-white flex items-center justify-center hover:text-black hover:bg-gray-100 cursor-pointer rounded-xl text-sm p-2.5"
          onClick={copyCode}
        ...
        <Button
          ...
          className="bg-gray-100 text-black ml-2 py-2 px-4 border border-black rounded-xl hover:bg-gray-400 focus:outline-none"
