...
function PreviewPane({ settings, onOpenVersions }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      >
          <div className="relative flex items-center justify-between px-3 py-1.5 shrink-0 border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
          <div className="flex items-center gap-2">
            ...
            {(activeTab === "desktop" || activeTab === "mobile") && (
              <div className="hidden sm:inline-flex items-center gap-2">
                {activeTab === "desktop" && (
                  <div className="inline-flex items-center rounded-xl bg-gray-100 p-1 dark:bg-zinc-800">
                    <button
                      type="button"
                    ...
                    >
                      Scale
                      {desktopScale < 1 && (
                        <span className="ml-1 text-indigo-600 dark:text-indigo-300 font-bold">
